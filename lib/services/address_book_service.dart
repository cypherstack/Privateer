...
class AddressBookService extends ChangeNotifier {
  ...
  Future<bool> addContact(Contact contact) async {
    if (await MainDB.instance.isContactEntryExists(id: contact.id)) {
      ...
      await MainDB.instance
          .putContactEntry(contactEntry: turnContactToEntry(contact: contact));
  ...
  Future<bool> editContact(Contact editedContact) async {
    ...
    await MainDB.instance.putContactEntry(
        contactEntry: turnContactToEntry(contact: editedContact));
    _refreshAddressBookEntries();
    return true;
  }
